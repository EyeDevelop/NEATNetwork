...
class SnekAI:
    def __init__(self, load_neat_file=""):
        ...
        if not neat_loaded:
            self.neat_object = NEAT(layer_count=2, neuron_counts=[24, 25, 25, 4], population_size=500, retention_rate=50, mutation_chance=0.05, mutation_severity=2, activation_function="sigmoid", breeding_function="crossover")
